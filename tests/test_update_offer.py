import allure
from methods.update_offer_methods import UpdateOrderMethods
...
class TestUpdateOrder:
    ...
    def test_update_order_created_by_auth_user_status_code_200(self, get_auth_token_and_order_id, email_generator):
        ...
        method = UpdateOrderMethods(token, order_id, email_generator)
    ...
    def test_update_order_not_created_by_auth_user_status_code_401(self,get_auth_token_and_order_id, email_generator):
        ...
        update_order_method = UpdateOrderMethods(auth_token=second_user_token, order_id=order_id, new_name=email_generator)
