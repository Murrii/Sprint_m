...
class TestCreateListing:
    ...
    def test_create_new_order_with_all_categories_successful_status_code_201(self, get_auth_token, category):
        method = CreateListingMethods(get_auth_token, category)
        status_code, json = method.create_new_order()
